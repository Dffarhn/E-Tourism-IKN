...
if (isset($_SESSION['edit_blog'])) {
  $id_blog_now = $_SESSION['edit_blog'];
  ?>
 <!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    ?>
        ...
        <div class="mb-3 mt-4 our_service_word" >
          <h2> Edit Post Blog</h2>
          <?php
          $result = mysqli_query($conn, "SELECT * FROM `destinasiwisata` WHERE id_destinasi = $id_blog_now;");
          ...
          <form action="uploadblogproses.php" method="post">
            ...
            <label class="image_button">
                    ...
                    <input type="text" class="show_url_image" id="selected_image" name="image_url" style="width: 30%; padding: 1% 2%;" value="<?php echo $row['gambar']?>" readonly>
            </div>
