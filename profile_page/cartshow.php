...
$result2 = mysqli_query($conn, "SELECT * FROM cart c JOIN bookingdestinasi bd ON c.id_booking = bd.id_booking WHERE c.id_admin = '$profile_now';");
...
?>
                ...
                <?php } ?>
                <a href="../profile_page/deletecart.php?id_cart=<?php echo $row['id_cart']; ?>">
