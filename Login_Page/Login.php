...
<body>
    ...
    <div class="login_form_cont col-md-4">
        <div class="login_form">
            <h3>Masuk</h3>


    
            <form action="login_p.php" method="post" class="main_form">
    
                <label>Username</label><br><br>
                <input type="text" name="username" id=""><br>
                <br><br>
                
                <label>Kata sandi</label><br> <br>
                ...
                <div class="button_login_cont">
                    ...
                    <p>Belum punya akun? <a href="../Registrasi_Page/registrasi.php">Daftar disini</a></p>
                </div>
