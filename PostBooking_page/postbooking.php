...
if (isset($_SESSION['edit_booking'])) {
    $id_booking_now = $_SESSION['edit_booking'];
    ?>
            ...
            ?>
              ...
              <form action="uploadbookingproses.php" method="post">
                <div class="row mt-4 justify-content-center px-4">
                    ...
                    <div class="col-md-6 mb-3 ">
                      <select name="jenis" id="" >
                        ...
                        while($row2 = mysqli_fetch_array($result_jenis, MYSQLI_ASSOC))
                        {
                            if ($row2['id_jenis'] == $row['id_jenis'] ) {?>
                            <option value="<?php echo $row2['id_jenis']?>" selected><?php echo $row2['nama_jenis']?></option>

                            <?php
                        }else{ ?>
                            <option value=<?php echo $row2['id_jenis']?>><?php echo $row2['nama_jenis']?></option>
                        <?php
                                }
                            ?>
                        <?php } ?>
                ...
                <div class="row mt-2 justify-content-center px-4">
                    <div class="col-md-6 mb-3">
                        <input name="harga" type="text" placeholder="Harga" value = "<?php echo $row['harga_awal']?>">
                    </div>
                    <div class="col-md-6 mb-3 ">
                    <input name="harga_promo" type="text" placeholder="Harga Promo" value = "<?php echo $row['harga_promo']?>">
                    </div>
                </div>
                <div class="row mt-4 justify-content-center px-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="show_url_image" id="selected_image" name="image_url" style="width: 50%; padding: 1% 2%;" value="<?php echo $row['gambar']?>" readonly>
                    </div>
                    <div class="col-md-6 mb-3 ">
                    <input name="fasilitas" type="text" placeholder="Facilities" value = "<?php echo $row['fasilitas']?>">
                    </div>
