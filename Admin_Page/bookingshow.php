...
<h2>DashBoard</h2>
  <div style="width: 25%; display:inline-block; margin: 0px 2px;">
  ...
  <div style="width: 25% ;display:inline-block">
    <a href="bookinghistory.php" style="text-decoration: none; color: inherit;">
  <div class="info-box bg-gradient-warning">
  <span class="info-box-icon">
  ...
  <i class="far fa-copy"></i></span>
  <div class="info-box-content">
    <span class="info-box-text">Riwayat Booking</span>
  </div>
</div>
