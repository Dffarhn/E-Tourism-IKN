...
?>
    ...
    <html lang="en">
      ...
      <body>
        ...
        <div class="row  justify-content-center px-5 mx-5 notification_look ">
            <div class = "col-md-10 px-5 text-center">
            <svg width="139" height="139" viewBox="0 0 139 139" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M69.4997 11.5834C37.4718 11.5834 11.583 37.4721 11.583 69.5C11.583 101.528 37.4718 127.417 69.4997 127.417C101.528 127.417 127.416 101.528 127.416 69.5C127.416 37.4721 101.528 11.5834 69.4997 11.5834Z" fill="#2C8900"/>
            <path d="M69.5003 32.4166C48.9932 32.4166 32.417 48.9929 32.417 69.5C32.417 90.007 48.9932 106.583 69.5003 106.583C90.0074 106.583 106.584 90.007 106.584 69.5C106.584 48.9929 90.0074 32.4166 69.5003 32.4166Z" fill="white"/>
            <path d="M65.11 81.25L54.8975 71.0375L57.4506 68.4844L65.11 76.1437L81.5485 59.7052L84.1016 62.2583L65.11 81.25Z" fill="#FF5722"/>
            </svg>
